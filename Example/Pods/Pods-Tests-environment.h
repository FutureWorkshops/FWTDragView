...
// FWTDragView
#define COCOAPODS_POD_AVAILABLE_FWTDragView
#define COCOAPODS_VERSION_MAJOR_FWTDragView 0
#define COCOAPODS_VERSION_MINOR_FWTDragView 1
#define COCOAPODS_VERSION_PATCH_FWTDragView 0
